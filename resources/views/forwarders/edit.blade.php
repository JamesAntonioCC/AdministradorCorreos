...
@section('title', 'Edit Forwarder - Administración de Correos')
...
<div class="max-w-2xl mx-auto">
    ...
    <!-- Page Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Email Forwarder</h1>
        <p class="text-gray-600">Update forwarding settings for {{ $forwarder->source_email }}</p>
    </div>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input 
                        ...
                        readonly
                    >
                    <p class="mt-1 text-sm text-gray-500">Source email address cannot be changed</p>
                </div>
                ...
                <div>
                    <label class="flex items-center">
                        ...
                        >
                        <span class="ml-2 text-sm text-gray-700">Forwarder is active</span>
                    </label>
                </div>
            </div>
