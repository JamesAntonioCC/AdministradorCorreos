...
@section('title', 'Detalles del Buzón - Administración de Correos')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600">Detalles y configuración del buzón</p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="p-6">
                    <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Dirección de Correo</dt>
                        ...
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Cuota de Almacenamiento</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $mailbox->formatted_quota }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Almacenamiento Usado</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $mailbox->formatted_storage_used }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Creado</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $mailbox->created_at->format('d/m/Y H:i') }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Último Acceso</dt>
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ $mailbox->last_login ? $mailbox->last_login->format('d/m/Y H:i') : 'Nunca' }}
                            </dd>
                        </div>
                    </dl>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900">Uso de Almacenamiento</h2>
                </div>
                <div class="p-6">
                    <div class="mb-4">
                        <div class="flex justify-between text-sm text-gray-600 mb-2">
                            <span>{{ $mailbox->formatted_storage_used }} usado</span>
                    ...
                    @if($mailbox->usage_percentage > 80)
                        <div class="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-yellow-800">Advertencia de Almacenamiento</h3>
                                    <div class="mt-2 text-sm text-yellow-700">
                                        <p>Este buzón está usando {{ $mailbox->usage_percentage }}% de su cuota de almacenamiento. Considera aumentar la cuota o limpiar correos antiguos.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900">Elementos Relacionados</h2>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="text-center p-4 border border-gray-200 rounded-lg">
                            <div class="text-2xl font-bold text-indigo-600">{{ $mailbox->aliases->count() }}</div>
                            <div class="text-sm text-gray-500">Alias de Correo</div>
                        </div>
                        <div class="text-center p-4 border border-gray-200 rounded-lg">
                            <div class="text-2xl font-bold text-green-600">{{ $mailbox->autoReplies->count() }}</div>
                            <div class="text-sm text-gray-500">Respuestas Automáticas</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="p-6 space-y-3">
                    <a href="{{ route('mailboxes.edit', $mailbox) }}" class="flex items-center p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-gray-900">Editar Buzón</p>
                            <p class="text-xs text-gray-500">Actualizar configuración</p>
                        </div>
                    </a>
                    ...
                    <button type="button" class="flex items-center p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors w-full" onclick="openChangePasswordModal()">
                        ...
                        <div class="ml-3 text-left">
                            <p class="text-sm font-medium text-gray-900">Cambiar Contraseña</p>
                            <p class="text-xs text-gray-500">Actualizar contraseña de acceso</p>
                        </div>
                    </button>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900">Alias de Correo</h3>
                </div>
                <div class="p-6">
                    <div class="space-y-2">
